...
namespace DurangoInteropDotnet {
    ...
    public static class FirewallManager {
        ...
        private static readonly string FWPM_DISPLAY_NAME = "XBR";
        private static readonly string FWPM_DISPLAY_DESCRIPTION = "XBR FWPM Provider";
        ...
        private static void BuildAndAddFWPPortFilter(string name, ushort port, Guid layer, IntPtr IntPtr) {
            ...
            IntPtr pConditionArray = Marshal.AllocHGlobal(conditions.Length * Marshal.SizeOf<NativeBridge.FWPM_FILTER_CONDITION0>());
            for (int i = 0; i < conditions.Length; i++) {
                Marshal.StructureToPtr(conditions[i], pConditionArray + (i * Marshal.SizeOf<NativeBridge.FWPM_FILTER_CONDITION0>()), false);
            }
